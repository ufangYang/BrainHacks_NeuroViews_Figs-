...
world+
  geom_point(
    ...
    colour = "white",shape=21,alpha = 0.7, group=FALSE) + 
  scale_fill_viridis_d(option="B",direction = 1,alpha = 0.7)
# begin= 0, end =0.8, , aesthetics = "fill"
...
# save the fig
#library(svglite)
#("Output//buublemap.png", width = 5, height = 3, dpi = 300)
